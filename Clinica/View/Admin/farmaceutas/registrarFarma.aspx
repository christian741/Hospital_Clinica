<%@ Page Title="" Language="C#" MasterPageFile="~/View/Admin/masterAdmin.master" 
    AutoEventWireup="true" CodeFile="~/Controller/ConAdmin/farmaceutas/registrarFarma.aspx.cs" Inherits="View_Admin_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   
    REGISTRAR FARMACEUTA

    <asp:Label ID="label_sedes" runat="server" Text="Seleccione una Sede"></asp:Label>
    <asp:DropDownList ID="DDL_sede" runat="server" DataSourceID="OBDS_SedesDDL" DataTextField="sede_nombre;" DataValueField="sede_id"></asp:DropDownList>

    <asp:ObjectDataSource ID="OBDS_SedesDDL" runat="server" SelectMethod="ver_DDL_Sedes" TypeName="DAOSede"></asp:ObjectDataSource>
